...
public interface ExpressGrammarVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link ExpressGrammarParser#endSchema}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitEndSchema(ExpressGrammarParser.EndSchemaContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link ExpressGrammarParser#endEntity}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitEndEntity(ExpressGrammarParser.EndEntityContext ctx);
	/**
